 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var ky;function PE(){return ky||(ky=1,function(e){function t(_,L){var F=_.length;_.push(L);e:for(;0<F;){var Y=F-1>>>1,M=_[Y];if(0<o(M,L))_[Y]=L,_[F]=M,F=Y;else break e}}function r(_){return _.length===0?null:_[0]}function i(_){if(_.length===0)return null;var L=_[0],F=_.pop();if(F!==L){_[0]=F;e:for(var Y=0,M=_.length,k=M>>>1;Y<k;){var K=2*(Y+1)-1,X=_[K],I=K+1,te=_[I];if(0>o(X,F))I<M&&0>o(te,X)?(_[Y]=te,_[I]=F,Y=I):(_[Y]=X,_[K]=F,Y=K);else if(I<M&&0>o(te,F))_[Y]=te,_[I]=F,Y=I;else break e}}return L}function o(_,L){var F=_.sortIndex-L.sortIndex;return F!==0?F:_.id-L.id}if(e.unstable_now=void 0,typeof performance=="object"&&typeof performance.now=="function"){var s=performance;e.unstable_now=function(){return s.now()}}else{var u=Date,d=u.now();e.unstable_now=function(){return u.now()-d}}var m=[],h=[],p=1,y=null,b=3,w=!1,C=!1,x=!1,S=typeof setTimeout=="function"?setTimeout:null,$=typeof clearTimeout=="function"?clearTimeout:null,R=typeof setImmediate<"u"?setImmediate:null;function O(_){for(var L=r(h);L!==null;){if(L.callback===null)i(h);else if(L.startTime<=_)i(h),L.sortIndex=L.expirationTime,t(m,L);else break;L=r(h)}}function z(_){if(x=!1,O(_),!C)if(r(m)!==null)C=!0,U();else{var L=r(h);L!==null&&Z(z,L.startTime-_)}}var T=!1,A=-1,P=5,B=-1;function N(){return!(e.unstable_now()-B<P)}function H(){if(T){var _=e.unstable_now();B=_;var L=!0;try{e:{C=!1,x&&(x=!1,$(A),A=-1),w=!0;var F=b;try{t:{for(O(_),y=r(m);y!==null&&!(y.expirationTime>_&&N());){var Y=y.callback;if(typeof Y=="function"){y.callback=null,b=y.priorityLevel;var M=Y(y.expirationTime<=_);if(_=e.unstable_now(),typeof M=="function"){y.callback=M,O(_),L=!0;break t}y===r(m)&&i(m),O(_)}else i(m);y=r(m)}if(y!==null)L=!0;else{var k=r(h);k!==null&&Z(z,k.startTime-_),L=!1}}break e}finally{y=null,b=F,w=!1}L=void 0}}finally{L?j():T=!1}}}var j;if(typeof R=="function")j=function(){R(H)};else if(typeof MessageChannel<"u"){var W=new MessageChannel,V=W.port2;W.port1.onmessage=H,j=function(){V.postMessage(null)}}else j=function(){S(H,0)};function U(){T||(T=!0,j())}function Z(_,L){A=S(function(){_(e.unstable_now())},L)}e.unstable_IdlePriority=5,e.unstable_ImmediatePriority=1,e.unstable_LowPriority=4,e.unstable_NormalPriority=3,e.unstable_Profiling=null,e.unstable_UserBlockingPriority=2,e.unstable_cancelCallback=function(_){_.callback=null},e.unstable_continueExecution=function(){C||w||(C=!0,U())},e.unstable_forceFrameRate=function(_){0>_||125<_?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):P=0<_?Math.floor(1e3/_):5},e.unstable_getCurrentPriorityLevel=function(){return b},e.unstable_getFirstCallbackNode=function(){return r(m)},e.unstable_next=function(_){switch(b){case 1:case 2:case 3:var L=3;break;default:L=b}var F=b;b=L;try{return _()}finally{b=F}},e.unstable_pauseExecution=function(){},e.unstable_requestPaint=function(){},e.unstable_runWithPriority=function(_,L){switch(_){case 1:case 2:case 3:case 4:case 5:break;default:_=3}var F=b;b=_;try{return L()}finally{b=F}},e.unstable_scheduleCallback=function(_,L,F){var Y=e.unstable_now();switch(typeof F=="object"&&F!==null?(F=F.delay,F=typeof F=="number"&&0<F?Y+F:Y):F=Y,_){case 1:var M=-1;break;case 2:M=250;break;case 5:M=1073741823;break;case 4:M=1e4;break;default:M=5e3}return M=F+M,_={id:p++,callback:L,priorityLevel:_,startTime:F,expirationTime:M,sortIndex:-1},F>Y?(_.sortIndex=F,t(h,_),r(m)===null&&_===r(h)&&(x?($(A),A=-1):x=!0,Z(z,F-Y))):(_.sortIndex=M,t(m,_),C||w||(C=!0,U())),_},e.unstable_shouldYield=N,e.unstable_wrapCallback=function(_){var L=b;return function(){var F=b;b=L;try{return _.apply(this,arguments)}finally{b=F}}}}(Pm)),Pm}var Fy;function _E(){return Fy||(Fy=1,Nm.exports=PE()),Nm.exports}var _m={exports:{}},er={};/**
 * @license React
...
今天在教会 一个朋友说可以去这里买二手儿童产品：https://mercercounty.jbfsale.com
      `}],zP=()=>{const e=Hh(),[t,r]=f.useState(_s),[i,o]=f.useState(""),s=m=>{o(m.target.value)},u=()=>{console.log("search tearm: ",i);const m=_s.filter(h=>{var p;return(p=h.title)==null?void 0:p.includes(i)});r(m)},d=()=>{r(_s),o("")};return nt.jsxs("div",{style:{padding:"24px 24px",display:"flex",flexDirection:"column",gap:"16px"},children:[nt.jsxs("div",{style:{display:"flex",gap:"8px",alignItems:"center"},children:["Search:"," ",nt.jsx(Rl,{placeholder:"",size:"small",style:{width:"200px"},value:i,onChange:s}),nt.jsx(Zi,{size:"small",onClick:u,children:"Search"}),nt.jsx(Zi,{size:"small",onClick:d,children:"Clear"})]}),nt.jsxs("div",{style:{display:"flex",gap:"8px",alignItems:"baseline"},children:["目前包括的内容涵盖一下方面：",_s.map(m=>m.title+", ")]}),nt.jsx(u7,{gutter:16,style:{display:"flex",gap:"16px"},children:t.map(m=>nt.jsx(Sv,{title:m.title,variant:"borderless",style:{overflow:"hidden",paddingBottom:"8px",whiteSpace:"pre-line"},className:"card-container",actions:[nt.jsx(Zi,{onClick:()=>e(`/notes/${m.id}`),children:"Show More"})],children:m.content.substring(0,200)+"..."},m.title))})]})},LP=()=>{const{noteId:e}=m6(),t=_s[e-1],r=Hh();return nt.jsxs("div",{style:{padding:"16px 16px",lineHeight:"28px",whiteSpace:"pre-line",textAlign:"start"},children:[nt.jsx(Zi,{onClick:()=>r("/notes"),children:"Back"}),nt.jsx("div",{children:t.content})]})},HP={backgroundColor:"white",display:"flex"};function BP(){const{Header:e,Footer:t,Sider:r,Content:i}=no,o=[{label:nt.jsx("a",{href:"/",children:"主页"}),key:"home",icon:nt.jsx(EP,{})},{label:nt.jsx("a",{href:"#/notes",children:"信息分享"}),key:"news",icon:nt.jsx(TP,{})},{label:nt.jsx("a",{href:"#/feedback",children:"用户反馈"}),key:"feedback",icon:nt.jsx(RP,{})}];return nt.jsxs(no,{style:{minHeight:"100vh",display:"flex",flexDirection:"column",flexGrow:"1"},children:[nt.jsxs(e,{style:HP,children:[nt.jsx("div",{style:{fontSize:"26px",fontWeight:"700"},children:"Princeton华人"}),nt.jsx(gc,{items:o,mode:"horizontal",style:{marginLeft:"2rem"}})]}),nt.jsx(i,{children:nt.jsx(X6,{basename:"/",children:nt.jsxs(T6,{children:[nt.jsx(Ms,{path:"/notes/:noteId",element:nt.jsx(LP,{})}),nt.jsx(Ms,{path:"/notes",element:nt.jsx(zP,{})}),nt.jsx(Ms,{path:"/feedback",element:nt.jsx(DP,{})}),nt.jsx(Ms,{exact:!0,path:"/",element:nt.jsx(MP,{})})]})})})]})}HE.createRoot(document.getElementById("root")).render(nt.jsx(f.StrictMode,{children:nt.jsx(BP,{})}));
